...
class TestMultiConstraint:
    ...
    def test_match_true(self):
        ...
        c3 = TimeConstraint({'from': '11:00', 'until':'15:00'}, offset=9)
    ...
    def test_match_any_same_type(self):
        ...
        c1 = TimeConstraint({'from': '00:00', 'until':'02:00'}, offset=9)
        c2 = TimeConstraint({'from': '22:00', 'until':'23:59'}, offset=9)
        c = MultiConstraint(c1, c2)
        assert c.match(record_date) == True
...
class TestTimeConstraint:
    ...
    def test_from_true(self):
        record_date = parser.parse('2021-07-01T12:00:00+09:00')
        tc = TimeConstraint({'from':'10:00'}, offset=9)
        assert tc.match(record_date) == True
        tc = TimeConstraint({'from':'12:00'}, offset=9)
        assert tc.match(record_date) == True

    def test_from_false(self):
        record_date = parser.parse('2021-07-01T12:00:00+09:00')
        tc = TimeConstraint({'from':'14:00'}, offset=9)
        assert tc.match(record_date) == False

    def test_until_true(self):
        record_date = parser.parse('2021-07-01T12:00:00+09:00')
        tc = TimeConstraint({'until':'14:00'}, offset=9)
        assert tc.match(record_date) == True
        tc = TimeConstraint({'until':'12:00'}, offset=9)
        assert tc.match(record_date) == True

    def test_until_false(self):
        record_date = parser.parse('2021-07-01T12:00:00+09:00')
        tc = TimeConstraint({'until':'10:00'}, offset=9)
        assert tc.match(record_date) == False

    def test_range_true(self):
        record_date = parser.parse('2021-07-01T12:00:00+09:00')
        tc = TimeConstraint({'from':'10:00', 'until':'14:00'}, offset=9)
        assert tc.match(record_date) == True
    ...
    def test_over_midnight(self):
        ...
        tc = TimeConstraint({'from':'23:00', 'until':'02:00'}, offset=9)
        assert tc.match(record_date) == True
