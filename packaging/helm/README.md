...
| googlechat.image.repository | string | `"snoozeweb/snooze-googlechat"` | The image to use for snooze-googlechat |
...
| server.image.repository | string | `"snoozeweb/snooze"` | The image to use for snooze-server |
...
| snmptrap.image.repository | string | `"snoozeweb/snooze-snmptrap"` | The image to use for snooze-snmptrap |
...
| syslog.image.repository | string | `"snoozeweb/snooze-syslog"` | The image to use for snooze-syslog |
